...
const AboutMe = () => {
  return (
    <div className="about-me-container container-fluid row ">
      <div className="about-me col-12 col-md-8">
        <div className="about-me-row row">
          <div className="col-8 col-md-4 headshot-container">
            <img src="/assets/headshot.jpg" className="headshot" />
          </div>
          <div className="about-me-text col-12 col-md-8">
            <h2>Hey, I'm Kevin!</h2>
